function startup() {
  ...
  span.setAttribute('style', 'cursor:pointer;text-decoration:underline;color:blue;');
  ...
  span.setAttribute('style', 'cursor:pointer;color:blue;text-decoration:underline;');
  ...
  div.appendChild(span);
  span = gCli.doc.createElement('span');
  span.setAttribute('style', 'cursor:pointer;text-decoration:underline;color:orange');
